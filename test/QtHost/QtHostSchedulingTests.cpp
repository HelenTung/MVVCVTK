...
bool TestScheduling()
{
    ...
    cropConfig.defaultTarget.referenceView.viewId = "a";
    cropConfig.defaultTarget.targetViews.viewIds = {"a"};
    cropConfig.defaultTarget.isTargetViewsUsed = true;
    cropConfig.inputViews.viewIds = {"a"};
    auto crop = std::make_shared<CropHostFeature>(cropConfig);
    CropHostRequest box;
    box.action = CropHostAction::Box;
    box.target = cropConfig.defaultTarget;
    ...
    mode.target = cropConfig.defaultTarget;
    ...
    materialize.target = cropConfig.defaultTarget;
