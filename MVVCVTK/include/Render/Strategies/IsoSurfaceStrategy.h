...
private:
    ...
    vtkSmartPointer<MaskImplicit> m_qualityMaskFunc;
    vtkSmartPointer<MaskImplicit> m_interactionMaskFunc;
    vtkSmartPointer<vtkClipPolyData> m_qualityClip;
    vtkSmartPointer<vtkClipPolyData> m_interactionClip;
