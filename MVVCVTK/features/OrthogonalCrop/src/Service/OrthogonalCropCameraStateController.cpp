...
void OrthogonalCropCameraStateController::Save(vtkRenderer* renderer)
{
    m_cameraState = {};
...
void OrthogonalCropCameraStateController::Restore(vtkRenderer* renderer)
{
...
bool OrthogonalCropCameraStateController::HasSaved() const
{
