...
private:
    ...
    bool SendPreview(
        const std::pair<std::shared_ptr<InteractiveService>, std::shared_ptr<CropOverlay>>& target,
...
const char* CropBridge::Impl::GetRemovalModeText(CropRemovalMode removalMode)
{
    switch (removalMode) {
